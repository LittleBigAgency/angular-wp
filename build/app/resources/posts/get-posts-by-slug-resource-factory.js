 ...
 *
 **/
angular.module('app.resources').factory('GetPostsBySlugFactory', ['$resource', function($resource) {
  return $resource('/wordpress/wp-json/posts/?filter[name]=:postSlug', {postSlug: '@slug'});
}]);
